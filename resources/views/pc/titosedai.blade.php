  ...
  <!--メニューバー-->
    <nav>
     <ul class="menu">
       ...
       <li><a href="/"><img src="{{ asset('img/menupic5.png') }}"width="60px" height="50px">弦巻店について</a></li>
     </ul>
    </nav>
  </div>
  <!--スライドショー-->
 ...
 <!--店舗情報-->
  <div id="content4">
   <div class="map">
	...
	<li>【営業時間】<br>月曜〜日曜日AM9:00~PM7:00<br>日曜祝日AM10:00~PM6:00<br><span class="dayoff">定休日なし</span></li>
        <li>☎︎03-3483-5572</li>
